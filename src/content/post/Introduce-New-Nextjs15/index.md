...
# 2. Breaking Change‌ های مهم Next.js 15
...
### 3.1 رفتار جدید Fetch — بدون Cache پیش‌فرض
...
Next.js یه ابزار خودکار داره که بیشتر breaking change ها رو حل می‌کنه:
...
* به‌روزرسانی نسخه Next.js و React
* اصلاح کد برای سازگاری با breaking changeها
* بروزرسانی ESLint و dependencyها
* اعمال تنظیمات جدید مورد نیاز
